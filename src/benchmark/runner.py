    ...
    for idx, case in enumerate(case_list, start=1):
        ...
        try:
            ...
            result = BenchmarkRunResult(
                ...
                max_core=int(payload.get("max_core") or 0),
                max_context=int(payload.get("max_context") or 0),
                policy_trace=payload.get("policy_trace") or {},
                core_cite_keys=payload.get("core_cite_keys") or [],
                context_cite_keys=payload.get("context_cite_keys") or [],
                semantic_route=payload.get("semantic_route") or {},
                focus_detection_mode=payload.get("focus_detection_mode") or "",
                focus_detection_model=payload.get("focus_detection_model") or "",
                focus_catalog_version=payload.get("focus_catalog_version") or "",
                focus_detection_result=payload.get("focus_detection_result") or {},
                focus_summary=payload.get("focus_summary") or "",
                query_len_original=payload.get("query_len_original"),
                query_len_embedded=payload.get("query_len_embedded"),
                query_was_truncated=payload.get("query_was_truncated"),
                retrieval_query_strategy=payload.get("retrieval_query_strategy") or "",
                embedding_query_preview=payload.get("embedding_query_preview") or "",
                retrieval_query_preview=payload.get("retrieval_query_preview") or "",
            ...
            result = BenchmarkRunResult(
                ...
                context_cite_keys=[],
                semantic_route={},
                focus_detection_mode="",
                focus_detection_model="",
                focus_catalog_version="",
                focus_detection_result={},
                focus_summary="",
                query_len_original=None,
                query_len_embedded=None,
                query_was_truncated=None,
